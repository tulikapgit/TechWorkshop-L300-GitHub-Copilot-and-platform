...
**Before you begin**, review the planning documentation to understand the infrastructure requirements:
* [Quick Reference Guide](QUICK_REFERENCE.md) - Essential checklist and commands
* [Azure Infrastructure Planning Guide](AZURE_INFRASTRUCTURE_PLANNING.md) - Detailed architecture and requirements
...
- [Creating issues with GitHub Copilot](https://docs.github.com/en/copilot/how-tos/use-copilot-for-common-tasks/use-copilot-to-create-or-update-issues){:target="_blank"}
